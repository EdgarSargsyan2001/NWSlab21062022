...
const ArrInfo3 = [
  {
    ...
    titleHover:"AddMeFast",
    descHover:"sdfsdfdfsdfs"
  },
  {
    title:"AddMe-Fast",
    desc:"Strengthen your IT team with NWSLAB's top-notch experts while retaining full responsibility for your IT ",
    imgUrl:"../../Assets/img2.jpeg" ,
    titleHover:"AddMeFast",
    descHover:"AddMeFast provide the widest and the most spacious choice of social media exchange in today's world of limitless and infinite internet possibilities"
